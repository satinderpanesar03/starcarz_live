...
@section('title', isset($insurance->id) ? 'Edit Term Insurance Claim' :'Add Term Insurance Claim')
@section('content')
                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-header" style="background-color: #d6d6d6; color: #000000;  z-index: 1;">
                                    <div class="row">
                                        <div class="col-12 col-sm-7">
                                            <h5 class="pt-2 pb-2">@if(isset($insurance->id)) Edit @else Add @endif Term Insurance Claim</h5>
                                        </div>
                                        <div class="col-12 col-sm-5 d-flex justify-content-end align-items-center">
                                            <a href="{{route('admin.claim.term-insurance.store')}}" class="btn btn-sm btn-primary px-3 py-1">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <form method="post" action="{{route('admin.claim.term-insurance.store')}}" enctype="multipart/form-data">
                                                @csrf
        ...
        $('#policy_number_id').change(function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#insurance_done_by').val(response.insurance_done_by);
