...
@section('title','View Term Insurance Claim')
@section('content')
                                ...
                                <div class="card-header" style="background-color: #d6d6d6; color: #000000;  z-index: 1;">
                                    <div class="row">
                                        <div class="col-12 col-sm-7">
                                            <h5 class="pt-2 pb-2">View Term Insurance Claim</h5>
                                        </div>
                                        <div class="col-12 col-sm-5 d-flex justify-content-end align-items-center">
                                            <a href="{{route('admin.claim.term-insurance.index')}}" class="btn btn-sm btn-primary px-3 py-1">
