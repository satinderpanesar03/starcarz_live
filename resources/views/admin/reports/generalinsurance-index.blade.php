                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-12 col-sm-7">
                                            <h5 class="pt-2 pb-2">General Insurance List</h5>
                                        </div>
                                ...
                                <form action="{{route('admin.general-insurance-report.index')}}" method="get">
...
<script>
    ...
    $(document).ready(function() {
        $('.export-to-csv').on('click', function(e) {
            ...
            var url = '{{ route('admin.general-insurance-report.export', ['extension' => 'csv']) }}';
