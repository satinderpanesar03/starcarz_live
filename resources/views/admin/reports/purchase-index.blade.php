                            ...
                            <div class="card">
                                <div class="card-content">
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-12 col-sm-7">
                                                <h5 class="pt-2 pb-2">Purchase Enquiry List</h5>
                                            </div>
                                    ...
                                    <div class="card-body table-responsive">
                                        <form action="{{ route('admin.purchase-report.index') }}" id="search" method="get">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control status-filter" id="statusFilter" name="statusFilter">
                                                                    ...
                                                                    <option value="{{ $id }}" {{ request()->get('statusFilter') == $id ? 'selected' : '' }}>{{ $model }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="card-body table-responsive">
                                            <form action="{{route('admin.purchase-report.index')}}" method="get">
                                                <div><label>Show
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.export-to-csv').on('click', function(e) {
                ...
                var executiveFilter = $('#executiveFilter').val();
                ...
                var url = '{{ route('admin.purchase-report.export', ['extension' => 'csv']) }}';
                url += `?executiveFilter=${executiveFilter}&partyFilter=${partyFilter}&modelFilter=${modelFilter}&statusFilter=${statusFilter}&fromDate=${fromDate}&toDate=${toDate}`;
