                        ...
                        <div class="card">
                            <div class="card-content">
                                ...
                                <div class="card-body table-responsive">
                                    <form action="{{ route('admin.businessmortage-loan-report.index') }}" id="search" method="get">
                                    ...
                                    <div class="card-body table-responsive">
                                        <form action="{{route('admin.businessmortage-loan-report.index')}}" method="get">
                                            <div><label>Show
...
<script>
    ...
    $(document).ready(function() {
            $('.export-to-csv').on('click', function(e) {
                ...
                var url = '{{ route('admin.businessmortage-loan-report.export', ['extension' => 'csv']) }}';
