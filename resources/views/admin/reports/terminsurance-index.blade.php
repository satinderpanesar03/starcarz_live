                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-12 col-sm-7">
                                            <h5 class="pt-2 pb-2">Term Insurance List</h5>
                                        </div>
                                ...
                                <form action="{{route('admin.term-insurance-report.index')}}" method="get">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><span style="white-space:nowrap;" class="">
                                                        ...
                                                        <!-- <a href="{{route('admin.term.insurance.show', $item->id)}}" class="btn btn-success btn-sm" title="Edit">
...
<script>
    ...
    $(document).ready(function() {
        $('.export-to-csv').on('click', function(e) {
            ...
            var url = '{{ route('admin.term-insurance-report.export', ['extension' => 'csv']) }}';
