                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-content">
                                ...
                                <form action="{{route('admin.car.insurance.renewal-index')}}" method="get">
                                ...
                                <div class="card-body table-responsive">
                                    ...
                                    <table class="table table-striped table-bordered dom-jQuery-events">
                                        ...
                                        <tbody>
                                            @foreach ($carInsurances as $value => $item)
                                            <tr>
                                                <td>{{++$value}}</td>
                                                ...
                                                <td><span style="white-space:nowrap;" class="">
                                                        ...
                                                        <a href="{{route('admin.car.insurance.show', ['id' => $item->id, 'renewal' => true])}}" class="btn btn-secondary btn-sm" title="Renewal">
