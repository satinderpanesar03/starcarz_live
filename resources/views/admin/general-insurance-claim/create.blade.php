...
@section('title', isset($insurance->id) ? 'Edit General Insurance Claim' :'Add General Insurance Claim')
@section('content')
                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-header" style="background-color: #d6d6d6; color: #000000;  z-index: 1;">
                                    <div class="row">
                                        <div class="col-12 col-sm-7">
                                            <h5 class="pt-2 pb-2">@if(isset($insurance->id)) Edit @else Add @endif General Insurance Claim</h5>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <form method="post" action="{{route('admin.claim.general-insurance.store')}}" enctype="multipart/form-data">
                                                @csrf
