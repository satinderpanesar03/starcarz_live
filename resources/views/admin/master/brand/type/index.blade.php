                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-12 col-sm-7">
                                            <h5 class="pt-2 pb-2">Manage Brands List</h5>
                                        </div>
                                        <div class="col-12 col-sm-5 d-flex justify-content-end align-items-center">
                                            <button class="btn btn-sm btn-danger px-3 py-1 mr-2" id="listing-filter-toggle">
                                                <i class="fa fa-filter"></i> Filter </button>
                                            <a href="{{route('admin.master.brand-type.add')}}" class="btn btn-sm btn-primary px-3 py-1">
                                ...
                                <div class="card-body table-responsive">
                                    <form action="{{route('admin.master.brand-type.index')}}" method="get">
                                        <div class="row mb-2" id="listing-filter-data" data-select2-id="listing-filter-data" style="display:none;">
                                            <div class="row col-sm-12 ml-2">
                                                <div class="col-sm-3">
                                                    ...
                                                    <input class="form-control" placeholder="Brand Name" type="text" id="search" name="type" value="{{request()->query('type') ?? ''}}">
                                                </div>
                                            </div>
                                    ...
                                    <table class="table table-striped table-bordered dom-jQuery-events">
                                        ...
                                        <tbody>
                                            @forelse($types as $value => $type)
                                            <tr>
                                                <td>{{++$value}}</td>
                                                <td>{{ucfirst($type->type)}}</td>
                                                <td class="text-truncate">
                                                    <span style="white-space:nowrap;" class="">
                                                        <a href="{{route('admin.master.brand-type.view', $type->id)}}" class="btn btn-primary btn-sm" title="View">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                        <a href="{{route('admin.master.brand-type.show', $type->id)}}" class="btn btn-success btn-sm" title="Edit">
