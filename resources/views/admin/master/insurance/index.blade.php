                        ...
                        <div class="card">
                            <div class="card-content">
                                ...
                                <div class="row mb-2" id="listing-filter-data" data-select2-id="listing-filter-data" style="display:none;">
                                    <div class="row col-sm-12 ml-2">
                                        <div class="col-sm-3">
                                            ...
                                            <input class="form-control" placeholder="Name" type="text" id="search" name="name">
                                        </div>
                                        <div class="col-sm-3">
                                            <span class="text">Enter Address</span>
                                            <input class="form-control" placeholder="Address" type="number" id="search" name="address">
                                        </div>

                                        <div class="col-sm-3">
                                            <span class="text">Enter City</span>
                                            <input class="form-control" placeholder="City" type="text" id="search" name="city">
                                        </div>
                                    </div>
                                ...
                                <div class="card-body table-responsive">
                                    <div class="card-body table-responsive">
                                        <form action="{{route('admin.master.insurance.index')}}" method="get">
                                            <div><label>Show
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-truncate">
                                                    <span style="white-space:nowrap;" class="">
                                                        ...
                                                        <a href="{{route('admin.master.insurance.show', $insurance->id)}}" class="btn btn-success btn-sm" title="Edit">
