...
@section('title', 'View Insurance Type')
@section('content')
                                ...
                                <div class="card-header" style="background-color: #d6d6d6; color: #000000;  z-index: 1;">
                                    <div class="row">
                                        <div class="col-12 col-sm-7">
                                            <h5 class="pt-2 pb-2">View Insurance Type</h5>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <form method="post" action="{{route('admin.master.insurance-type.store')}}">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select name="insurance_id" id="insurance_id" class="form-control" disabled>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" name="name" class="form-control" placeholder="Enter Insurance Type" value="@if(isset($insurance->id)){{$insurance->name}}@else{{old('name')}}@endif" readonly>
                                                    </div>
                                                </div>
                                                <!-- <div class="col-sm-10">
