                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-12 col-sm-7">
                                            <h5 class="pt-2 pb-2">Manage Suppliers List</h5>
                                        </div>
                                        <div class="col-12 col-sm-5 d-flex justify-content-end align-items-center">
                                            <button class="btn btn-sm btn-danger px-3 py-1 mr-2" id="listing-filter-toggle">
                                                <i class="fa fa-filter"></i> Filter </button>
                                            <a href="{{route('admin.master.supplier.add')}}" class="btn btn-sm btn-primary px-3 py-1">
                                ...
                                <div class="row mb-2" id="listing-filter-data" data-select2-id="listing-filter-data" style="display:none;">
                                    <div class="row col-sm-12 ml-2">
                                        <div class="col-sm-3">
                                            <span class="text">Enter Supplier</span>
                                            <input class="form-control" placeholder="Supplier Name" type="text" id="search" name="supplier">
                                        </div>
                                    </div>
                                ...
                                <div class="card-body table-responsive">
                                    <div class="card-body table-responsive">
                                        <form action="{{route('admin.master.supplier.index')}}" method="get">
                                            <div><label>Show
                                    ...
                                    <table class="table table-striped table-bordered dom-jQuery-events">
                                        ...
                                        <tbody>
                                            @forelse($suppliers as $value => $supplier)
                                            <tr>
                                                <td>{{++$value}}</td>
                                                <td>{{ucfirst($supplier->supplier)}}</td>
                                                <td class="text-truncate">
                                                    <span style="white-space:nowrap;" class="">
                                                        <a href="{{route('admin.master.supplier.view', $supplier->id)}}" class="btn btn-primary btn-sm" title="View">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                        <a href="{{route('admin.master.supplier.show', $supplier->id)}}" class="btn btn-success btn-sm" title="Edit">
