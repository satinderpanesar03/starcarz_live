                            ...
                            <div class="card-content">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-12 col-sm-7">
                                            <h5 class="pt-2 pb-2">Manage Articles List</h5>
                                        </div>
                                        <div class="col-12 col-sm-5 d-flex justify-content-end align-items-center">
                                            <button class="btn btn-sm btn-danger px-3 py-1 mr-2" id="listing-filter-toggle">
                                                <i class="fa fa-filter"></i> Filter </button>
                                            <a href="{{route('admin.master.article.add')}}" class="btn btn-sm btn-primary px-3 py-1">
                                ...
                                <div class="row mb-2" id="listing-filter-data" data-select2-id="listing-filter-data" style="display:none;">
                                    <div class="row col-sm-12 ml-2">
                                        <div class="col-sm-3">
                                            <span class="text">Enter Article</span>
                                            <input class="form-control" placeholder="Article Name" type="text" id="search" name="name">
                                        </div>
                                        <div class="col-sm-3">
                                            <span class="text">Select Type</span>
                                            <label for="article_type_id">Article Type:</label>
                                            <select name="article_type_id" id="search" class="form-control">
                                ...
                                <div class="card-body table-responsive">
                                    ...
                                    <table class="table table-striped table-bordered dom-jQuery-events">
                                        ...
                                        <tbody>
                                            @forelse($articles as $value => $article)
                                            <tr>
                                                <td>{{++$value}}</td>
                                                <td>{{($article->name)?ucfirst($article->name):''}}</td>
                                                <td>{{$article->getArticleTypeName($article->article_type_id)}}</td>
                                                ...
                                                <td class="text-truncate">
                                                    <span style="white-space:nowrap;" class="">
                                                        ...
                                                        <a href="{{route('admin.master.article.show', $article->id)}}" class="btn btn-success btn-sm" title="Edit">
