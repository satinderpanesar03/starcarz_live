                                ...
                                <div class="card-header" style="background-color: #d6d6d6; color: #000000;  z-index: 1;">
                                    <div class="row">
                                        <div class="col-12 col-sm-7">
                                            <h5 class="pt-2 pb-2">View Color</h5>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <form method="post" action="{{route('admin.master.color.store')}}">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" name="color" class="form-control" placeholder="Color" value="@if(isset($color->id)){{$color->color}}@else{{old('color')}}@endif" readonly data-validation-required-message="This First Name field is required">
                                                </div>
                                            </form>
                                        </div>
                                    </div>
