                                ...
                                <div class="card-header" style="background-color: #d6d6d6; color: #000000;  z-index: 1;">
                                    <div class="row">
                                        <div class="col-12 col-sm-7">
                                            <h5 class="pt-2 pb-2">View Model</h5>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <form method="post" action="{{route('admin.master.model.store')}}">
                                                ...
                                                <fieldset class="form-group">
                                                    <select class="form-control" name="mst_brand_type_id" id="basicSelect" disabled>
                                                ...
                                                <div class="form-group">
                                                    <input type="text" name="model" class="form-control" placeholder="Enter Vehicle Model" value="@if(isset($model->id)){{$model->model}}@else{{old('model')}}@endif" readonly data-validation-required-message="This First Name field is required">
                                                </div>
                                                <fieldset class="form-group">
                                                    <select class="form-control" name="luxury" id="luxury" disabled>
