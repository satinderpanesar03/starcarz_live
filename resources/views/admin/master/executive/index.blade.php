                                    ...
                                    <div class="card-header">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-5 d-flex justify-content-end align-items-center">
                                                ...
                                                <a href="{{ route('admin.master.executive.add') }}"
                                            ...
                                            <div class="row mb-2" id="listing-filter-data"
                                                ...
                                                <div class="row col-sm-12 ml-2">
                                                    <div class="col-sm-3">
                                                        ...
                                                        <input class="form-control" placeholder="Executive Name"
                                                            type="text" id="search" name="name"
                                                    ...
                                                    <tr
                                                        ...
                                                        <td class="text-truncate">
                                                            <div style="display: flex; align-items: center; gap: 5px;">
                                                                <a href="{{ route('admin.master.executive.view', $executive->id) }}"
                                                                    class="btn btn-primary btn-sm" title="View">
                                                                    <i class="fa fa-eye"></i>
                                                                </a>
                                                                <a href="{{ route('admin.master.executive.show', $executive->id) }}"
                                                                    class="btn btn-success btn-sm" title="Edit">
                                                                    <i class="fa fa-edit"></i>
                                                                </a>
                                                                <form
                                                                    action="{{ route('admin.master.executive.status', [$executive->id, (int) $executive->status]) }}"
                                                                    method="POST" style="margin: 0;">
                                                                    @csrf
                                                                    <input type="checkbox" @checked($executive->status)
                                                                        onchange="this.form.submit()" data-toggle="toggle"
                                                                        data-size="xs">
                                                                </form>
                                                            </div>
                                                        </td>
