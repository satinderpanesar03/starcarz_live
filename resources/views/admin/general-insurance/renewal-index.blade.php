                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-12 col-sm-7">
                                            <h5 class="pt-2 pb-2">Manage General Insurance List</h5>
                                        </div>
                                ...
                                <form action="{{route('admin.general.insurance.index')}}" method="get">
                                ...
                                <div class="card-body table-responsive">
                                    ...
                                    <table class="table table-striped table-bordered dom-jQuery-events">
                                        ...
                                        <tbody>
                                            @foreach ($generalInsurances as $value => $item)
                                            <tr>
                                                <td>{{++$value}}</td>
                                                ...
                                                <td><span style="white-space:nowrap;" class="">
                                                        ...
                                                        <a href="{{route('admin.general.insurance.show', ['id' => $item->id, 'renewal' => true])}}" class="btn btn-secondary btn-sm" title="Renewal">
                                                            <i class="fa fa-file"></i>
                                                        </a>
                                                        <!-- <a href="{{route('admin.general.insurance.show', $item->id)}}" class="btn btn-success btn-sm" title="Edit">
