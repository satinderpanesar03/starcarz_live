...
@section('title', isset($saleOrder->id) ? 'Edit Sale Order' :'Add Sale Order')
@section('content')
                                ...
                                <div class="card-header" style="background-color: #d6d6d6; color: #000000;  z-index: 1;">
                                    <div class="row">
                                        <div class="col-12 col-sm-7">
                                            <h5 class="pt-2 pb-2">@if(isset($saleOrder->id)) Edit @else Add @endif Sale Order</h5>
                                        </div>
                                            ...
                                            <form method="post" action="{{route('admin.sale.sale.order-store')}}" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 mt-2">
                                                        ...
                                                        <input type="text" id="price_p1" name="price_p1" class="form-control" value="@if(isset($saleOrder->id)){{$saleOrder->price_p1}}@else{{old('price_p1')}}@endif">
                                                    </div>
                                                    @if(Auth::guard('admin')->user()->role_id == 1)
                                                    <div class="col-md-4 mt-2">
                                                        <label for="price_p2">Price S2:</label>
                                                        <input type="text" id="price_p2" name="price_p2" class="form-control" value="@if(isset($saleOrder->id)){{$saleOrder->price_p2}}@else{{old('price_p2')}}@endif">
                                                    </div>
                                                    @endif
                                                </div>
                                                <hr style="border: #2A3F54 1px solid;">
