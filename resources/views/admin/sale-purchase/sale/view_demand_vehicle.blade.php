...
@section('title', 'View Demand Vehicle')
@section('content')
                                ...
                                <div class="card-header" style="background-color: #d6d6d6; color: #000000;  z-index: 1;">
                                    <div class="row">
                                        <div class="col-12 col-sm-7">
                                            <h5 class="pt-2 pb-2">View Demand Vehicle</h5>
                                        </div>
                                            ...
                                            <div class="modal-body">
                                                <div class="row justify-content-center">
                                                    <div class="col-md-8 mb-3">
                                                        ...
                                                        <input type="text" id="followup_date" name="vehicle[]" class="form-control" value="{{$vehicle->vehicle}}" data-role="tagsinput" readonly>
                                                    </div>
                                                    <div class="col-md-8 mb-3">
                                                        <label for="followup_date">Budget</label>

                                                        <select class="form-control" name="budget" disabled>
