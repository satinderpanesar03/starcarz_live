                                                ...
                                                <div class="row mb-2" id="listing-filter-data"
                                                    ...
                                                    <div class="row col-sm-12 ml-2">
                                                        ...
                                                        <div class="col-sm-3">
                                                            ...
                                                            <input type="text" id="carFilter" name="car_number"
                                                                class="form-control"
                                                                value="{{ request()->query('car_number') ?? '' }}"
                                                ...
                                                <tbody>
                                                    @forelse($purchases as $key => $purchase)
                                                        <tr
                                                            ...
                                                            <td style="color: inherit; font-size: 12px;">
                                                                {{ $purchase->party ? $purchase->party->party_name : '' }}
                                                            </td>
                                                            <td>
                                                                @if ($purchase->party)
                                                        ...
                                                        <td style="color: inherit; font-size: 12px;">
                                                            {{ $purchase->purchase ? ($purchase->purchase->executive ? $purchase->purchase->executive->name : '---') : '---' }}
                                                        </td>
                                                        <td>{{ $purchase->purchase ? ($purchase->purchase->carModel ? $purchase->purchase->carModel->model : '---') : '---' }}
                                                        </td>
                                                        <td>{{ $purchase->purchase ? $purchase->purchase->reg_number : '' }}
                                                        </td>
                                                        ...
                                                        <td class="text-truncate">
                                                            <span style="white-space:nowrap;" class="">
                                                                <a href="{{ route('admin.purchase.purchase.view-order', $purchase->id) }}"
                                                                    class="btn btn-primary btn-sm" title="View">
                                                                    <i class="fa fa-eye"></i>
                                                                </a>
                                                                @if (in_array(1, $roleNames))
                                                                    <a href="{{ route('admin.purchase.purchase.showOrder', [$purchase->id, 'q' => Crypt::encrypt($purchase->willing_insurance)]) }}"
