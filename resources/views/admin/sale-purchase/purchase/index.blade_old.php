                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control model-filter" id="modelFilter">
                                    ...
                                    <table class="table table-striped table-bordered dom-jQuery-events">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ ($purchase->party) ? $purchase->party->name : '' }}</td>
                                                ...
                                                <td>{{ ($purchase->manufacturing_year) ? $purchase->manufacturing_year : '' }}</td>
                                                <td>{{ ($purchase->reg_number) ? $purchase->reg_number : '' }}</td>
                                                <td>{{ ($purchase->expected_price) ? $purchase->expected_price : '' }}<a id="expected_price_edit" class="modal_updated_value" data-toggle="modal" data-target="#exampleModal" data-field="expected_price" data-field-name="Expected Price">
                                                        <i class="fa fa-edit"></i>
                                                    </a></td>
                                                <td>{{ ($purchase->valuation)?$purchase->valuation:'' }}<a id="valuation_edit" class="modal_updated_value" data-toggle="modal" data-target="#exampleModal" data-field="valuation" data-field-name="Valuation">
                                                        <i class="fa fa-edit"></i>
                                                    </a></td>
                                                <td>{{ ($purchase->remarks)?$purchase->remarks:'' }}<a id="remarks_edit" class="modal_updated_value" data-toggle="modal" data-target="#exampleModal" data-field="remarks" data-field-name="Remarks">
                                                        <i class="fa fa-edit"></i>
                                                    </a></td>
                ...
                if ($.fn.DataTable.isDataTable('#search')) {
                    ...
                    $('#fromDate, #toDate').on('change', function() {
                        ...
                        $.fn.dataTable.ext.search.push(function(settings, data, dataIndex) {
                            let date = moment(data[5], 'YYYY-MM-DD'); // Assuming the date is in the fourth column
