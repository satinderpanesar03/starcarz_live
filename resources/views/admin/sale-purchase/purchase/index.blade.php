                                ...
                                <div class="card">
                                    <div class="card-content">
                                        <div class="card-header">
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-5 d-flex justify-content-end align-items-center">
                                                    ...
                                                    @if ($list)
                                                        <a href="{{ route('admin.purchase.purchase.create') }}"
                                        ...
                                        <div class="card-body table-responsive">
                                            <form action="{{ route('admin.purchase.purchase.index') }}" id="search"
                                                method="get">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control executive-filter"
                                                                        id="executiveFilter" name="executiveFilter">
    ...
    @endforeach
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control model-filter"
                                                                        id="modelFilter" name="modelFilter">
                                                ...
                                                <tbody>
                                                    @forelse($purchases as $key => $purchase)
                                                        <tr>
                                                            ...
                                                            <td>{{ $purchase->firm_name ? $purchase->firm_name : '' }}
                                                            </td>
                                                            <td>{{ $purchase->contact_number ?? '' }}</td>
                                                            <td>{{ $purchase->executive ? $purchase->executive->name : '' }}
                                                            </td>
                                                            <td>{{ $purchase->carModel ? $purchase->carModel->model : '' }}
                                                            </td>
                                                            <td>{{ strtoupper($purchase->reg_number) ?? '' }}</td>
                                                            <td>{{ $purchase->manufacturing_year ?? '' }}</td>
                                                            <td>{{ $purchase->evaluation_date ? date('d M, Y', strtotime($purchase->evaluation_date)) : '' }}
                                                            </td>
                                                            ...
                                                            <td>
                                                                ...
                                                                @endphp
                                                                <span
                                                                    class="badge {{ $statusClass }}">{{ $purchase->getStatusName($purchase->status) }}</span>
                                                            </td>

                                                            <td class="text-truncatle">
                                                                <span style="white-space:nowrap;" class="">
                                                                    <a href="{{ route('admin.purchase.purchase.view', $purchase->id) }}"
                                                                        class="btn btn-primary btn-sm" title="View">
                                                                        <i class="fa fa-eye"></i>
                                                                    </a>
                                                                    <a href="{{ route('admin.purchase.purchase.show', $purchase->id) }}"
        ...
        <!-- Modal -->
        <div class="modal fade" id="exampleModal" data-backdrop="false" role="dialog"
                        ...
                        <form method="GET" id="updateForm" enctype="multipart/form-data">
                            <div class="row">
                                <input type="hidden" id="updateId" name="updateId"
                                    value="{{ !empty($purchase) ? $purchase->id : '' }}">
                                <div class="col-12 text-center">
                                    <div class="form-group" id="expected_price_group">
                                        <label for="expected_price" class="common_label"
                                            style="margin-right: 73%;">Expected Price:</label>
                                        <input type="text" id="expected_price" class="form-control"
                                            name="expected_price">
                                    </div>
                                    <div class="form-group" id="valuation_group">
                                        <label for="valuation" class="common_label"
                                            style="margin-right: 81%;">Valuation:</label>
                                        <input type="text" id="valuation" class="form-control" name="valuation">
                                    </div>
                                    <div class="form-group" id="remarks_group">
                                        <label for="remarks" class="common_label"
                                            style="margin-right: 84%;">Remarks:</label>
