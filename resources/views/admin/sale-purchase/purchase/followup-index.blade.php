                            ...
                            <div class="card">
                                <div class="card-content">
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-12 col-sm-7">
                                                <h5 class="pt-2 pb-2">Manage Follow Up List</h5>
                                            </div>
                                    ...
                                    <div class="card-body table-responsive">
                                        <form action="{{ route('admin.purchase.purchase.follow-up') }}" id="search" method="get">
                                        ...
                                        <table class="table table-striped table-bordered dom-jQuery-events">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ ($purchase->executiveName) ? $purchase->executiveName->name : '' }}</td>
                                                    <td>{{ ($purchase->carModel) ? $purchase->carModel->model : '' }}</td>
                                                    <td>{{ ($purchase->status == 4) ? date('d M, Y', strtotime($purchase->followup_date)) : date('d M, Y', strtotime($purchase->evaluation_date)) }}</td>
                                                    ...
                                                    <td class="text-truncatle">
                                                        <span style="white-space:nowrap;" class="">
                                                            <a href="{{ route('admin.purchase.purchase.view-followup', $purchase->id) }}" class="btn btn-primary btn-sm" title="View">
                                                                <i class="fa fa-eye"></i>
                                                            </a>
