                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <form method="post" action="{{route('admin.purchase.purchase.store')}}" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 mt-2" id="other">
                                                ...
                                                <hr style="border: #2A3F54 1px solid;">
                                                <h5>Asking Price</h5>
                                                <input type="hidden" name="rfs" value="true">
                                                <div class="col-md-4 mt-3">
                                                    <label for="actual_price">Price:</label>
                                                    <input type="text" name="actual_price" class="form-control" value="@if(isset($purchase->id)){{$purchase->actual_price}}@else{{old('actual_price')}}@endif">
                                                </div>
