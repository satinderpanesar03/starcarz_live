...
@section('title', isset($insurance->id) ? 'Edit Insurance Claim' :'Add Insurance Claim')
@section('content')
                                ...
                                <div class="card-header" style="background-color: #d6d6d6; color: #000000;  z-index: 1;">
                                    <div class="row">
                                        <div class="col-12 col-sm-7">
                                            <h5 class="pt-2 pb-2">@if(isset($insurance->id)) Edit @else Add @endif Insurance Claim</h5>
                                        </div>
                                            ...
                                            <form method="post" action="{{route('admin.claim.insurance.store')}}" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input class="form-control" type="date" name="policy_start_date" id="insurance_from_date" value="{{$insurance->policy_start_date ?? ''}}">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label for="policy_end_date">Policy End date:</label>
                                                        <input class="form-control" type="date" name="policy_end_date" id="insurance_to_date" value="{{$insurance->policy_end_date ?? ''}}">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <!-- <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input class="form-control" type="text" name="vehicle_number_input" id="vehicle_number_input" value="@if(isset($insurance)) {{$insurance->vehicle_number_input}} @endif" required>
                                                    </div>
                                                    <div class="col-md-3">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 mt-3">
                                                        ...
                                                        <input type="text" id="chassis_number" name="chassis_number" class="form-control" value="@if(isset($insurance)) {{$insurance->chassis_number}} @endif" readonly>
                                                    </div>
                                                    <div class="col-md-3 mt-3">
