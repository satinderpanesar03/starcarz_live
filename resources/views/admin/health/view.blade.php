...
@section('title','View Health Insurance')
@section('content')
                                ...
                                <div class="card-header" style="background-color: #d6d6d6; color: #000000;  z-index: 1;">
                                    <div class="row">
                                        <div class="col-12 col-sm-7">
                                            <h5 class="pt-2 pb-2">View Health Insurance</h5>
                                        </div>
                                            ...
                                            <form>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 mt-2">
                                                        ...
                                                        <select disabled name="party_id" id="mst_party_id" class="form-control">
                                                    ...
                                                    <div class="col-md-4 mt-2">
                                                        ...
                                                        <select name="executive_id" id="executive_id" class="form-control" disabled>
                                                            <option value="" selected disabled>Choose...</option>
                                                ...
                                                <div class="row">
                                                                ...
                                                                <div class="controls flex-grow-1">
                                                                    <div class="row">
                                                                        <div class="col-sm-10">
                                                                            ...
                                                                            <input type="text" name="member_names[]" class="form-control" placeholder="" value="{{$city->member_name}}" style="margin-top: 10px;" disabled>
                                                                            @endforeach
                                                                            @endif
                                                                        </div>
                                                                        <!-- <div class="col-sm-2">
                                                    ...
                                                    <div class="col-md-3 mt-3">
                                                        ...
                                                        <select name="insurance_company_id" id="insurance_company_id" class="form-control" disabled>
                                                    ...
                                                    <div class="col-md-3 mt-3">
                                                        ...
                                                        <select name="sub_type_id" id="insurance_company" class="form-control" disabled>
                                                            <option selected disabled="">Choose...</option>
