...
@section('title','Add Health Insurance')
@section('content')
                                            ...
                                            <form method="post" action="{{route('admin.health.store')}}" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="form-group mb-2">
                                                            ...
                                                            <div class="form-group mb-2 d-flex">
                                                                <div class="controls flex-grow-1">
                                                                    <div class="row">
                                                                        <div class="col-sm-10">
                                                                            <input type="text" name="member_names[]" class="form-control" placeholder="" value="{{$insurance->memberName[0]->member_name ?? old('member_name')}}" required>
                                                                        </div>
                                                                        <div class="col-sm-2">
                                                    ...
                                                    <div class="col-md-3 mt-3">
                                                        ...
                                                        <input class="form-control" type="date" name="start_date" id="start_date" value="{{$insurance->start_date ?? ''}}" required>
                                                    </div>
                                                    <div class="col-md-3 mt-3">
                                                        <label for="mst_brand_type_id">End Date:</label>
                                                        <input class="form-control" type="date" name="end_date" id="end_date" value="{{$insurance->end_date ?? ''}}" required>
                                                    </div>
                                                    <div class="col-md-3 mt-3">
                                                    ...
                                                    <div class="col-md-3 mt-3">
                                                        ...
                                                        <input type="file" class="form-control" name="policy_image" required>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3 mt-3">
                                                        ...
                                                        <select name="sub_type_id" id="insurance_company" class="form-control">
                                                            ...
                                                            <option value="{{$value}}" @if(isset($insurance) && $insurance->subTypes == $value) selected @endif>{{$company}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
