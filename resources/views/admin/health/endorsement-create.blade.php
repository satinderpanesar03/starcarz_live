                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-header" style="background-color: #d6d6d6; color: #000000;  z-index: 1;">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-5 d-flex justify-content-end align-items-center">
                                            <a href="{{route('admin.endorsement.health.insurance.index')}}" class="btn btn-sm btn-primary px-3 py-1">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <form method="post" action="{{route('admin.endorsement.health.insurance.store')}}" enctype="multipart/form-data">
                                                @csrf
            ...
            if (policy) {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        // Populate member names in separate fields
