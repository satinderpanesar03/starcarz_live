                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body table-responsive">
                                    ...
                                    <table class="table table-striped table-bordered dom-jQuery-events">
                                        ...
                                        <tbody>
                                            @foreach ($healthInsurances as $value => $item)
                                            <tr>
                                                <td>{{++$value}}</td>
                                                <td>{{$item->party ? strtoupper($item->party->party_name) : ''}}</td>
                                                <td>{{$item->policy_number}}</td>
                                                <td>{{date('d M, Y',strtotime($item->start_date))}}</td>
                                                <td>{{date('d M, Y',strtotime($item->end_date))}}</td>
                                                <td><span style="white-space:nowrap;" class="">
                                                        <a href="{{route('admin.health.view', $item->id)}}" class="btn btn-primary btn-sm" title="View">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                        <a href="{{route('admin.health.show', ['id' => $item->id, 'renewal' => true])}}" class="btn btn-secondary btn-sm" title="Renewal">
