                ...
                <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li class="has-sub nav-item"><a href="javascript:;"><i class="fa fa-list"></i><span class="menu-title" data-i18n="settings">Purchase</span></a>
                        <ul class="menu-content">
                            ...
                            <li class="nav-item {{ request()->routeIs('admin.purchase.purchase.orders') ? 'active' : '' }}""><a href=" {{route('admin.purchase.purchase.orders')}}"><i class="ft-arrow-right submenu-icon"></i><span class="menu-item" data-i18n="permissions">Purchase Register</span></a>
                            </li>
                        </ul>
                    </li>
                    @endif
