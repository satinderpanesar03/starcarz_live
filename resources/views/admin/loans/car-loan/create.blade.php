                                ...
                                <div class="card-header" style="background-color: #d6d6d6; color: #000000;  z-index: 1;">
                                    <div class="row">
                                        <div class="col-12 col-sm-7">
                                            <h5 class="pt-2 pb-2">@if(isset($carLoan->id)) Edit @else Add @endif Car Loan</h5>
                                        </div>
                                            ...
                                            <form method="post" action="{{route('admin.loan.car-loan.store')}}">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 mt-2">
                                                        ...
                                                        <select name="mst_party_id" id="mst_party_id" class="form-control"{{ (! $type) ? 'disabled' : '' }}>
                                                    ...
                                                    <div class="col-md-4 mt-2">
                                                        ...
                                                        <input type="date" id="dob_date" name="dob_date" class="form-control" value="{{ isset($carLoan) ? \Carbon\Carbon::parse($carLoan->dob_date)->format('Y-m-d') : old('dob_date') }}">
                                                    </div>
                                                    <div class="col-md-4 mt-2">
                                                ...
                                                <div id="approveFields" style="display: @if(isset($carLoan) && $carLoan->status == 2) block @else none @endif;">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 mt-3">
                                                            <label for="approved_amount">Approved Amount:</label>
                                                            <input class="form-control" type="text" name="approved_amount" id="approved_amount" value="{{ $carLoan->approved_amount ?? ($carLoan->loan_amount ?? '') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div id="disbursedFields" style="display: @if(isset($carLoan) && $carLoan->status == 4) block @else none @endif;">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 mt-2">
                                                            ...
                                                            <input class="form-control" type="number" name="roi" id="roi" step=".01" value="{{ $carLoan->roi ?? '' }}">
                                                        </div>
                                                        <!-- <div class="col-md-4 mt-2">
                                                        ...
                                                        <div class="col-md-4 mt-2">
                                                            ...
                                                            <input type="date" id="disbursed_date" name="disbursed_date" class="form-control" value="{{ isset($carLoan) ? $carLoan->disbursed_date : old('disbursed_date') }}"">
                                                        </div>
                                                        <div class=" col-md-4 mt-2">
                                                            <label for="emi_amount">EMI Amount:</label>
                                                            <input type="text" id="emi_amount" name="emi_amount" class="form-control" value="@if(isset($carLoan->id)){{$carLoan->emi_amount}}@else{{old('emi_amount')}}@endif">
                                                        </div>
                                                        <div class="col-md-4 mt-2">
                                                            <label for="emi_advance">EMI Advance:</label>
                                                            <input type="text" id="emi_advance" name="emi_advance" class="form-control" value="@if(isset($carLoan->id)){{$carLoan->emi_advance}}@else{{old('emi_advance')}}@endif">
                                                        </div>
                                                        <div class="col-md-4 mt-2">
                                                            <label for="emi_start_date">EMI Start Date:</label>
                                                            <input type="date" id="emi_start_date" name="emi_start_date" class="form-control" value="{{ isset($carLoan) ? $carLoan->emi_start_date : old('emi_start_date') }}"">
                                                        </div>
                                                        <div class=" col-md-4 mt-2">
                                                        ...
                                                        <div class="col-md-4 mt-2">
                                                            ...
                                                            <input type="text" id="loan_number" name="loan_number" class="form-control" value="@if(isset($carLoan->id)){{$carLoan->loan_number}}@else{{old('loan_number')}}@endif">
                                                        </div>
                                                    </div>
                                                </div>
                                                <hr style="border: #2A3F54 1px solid;">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="date" id="login_date" name="login_date" class="form-control" value="{{ isset($carLoan) ? \Carbon\Carbon::parse($carLoan->login_date)->format('Y-m-d') : old('login_date') }}">
                                                    </div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input class="form-control" type="text" name="vehicle_number" id="vehicle_number" value="@if(isset($carLoan)) {{$carLoan->vehicle_number}} @endif">
                                                    </div>
                                                    <!-- <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-4 mt-2">
                                                        ...
                                                        <input type="text" id="manufacturing_year" name="manufacturing_year" class="form-control" value="@if(isset($carLoan)) {{$carLoan->manufacturing_year}} @endif">
                                                    </div>
                                                    <!-- <div class="col-md-4 mt-2">
                                                    ...
                                                    <div class="col-md-4 mt-2">
                                                        ...
                                                        <input type="text" id="loan_amount" name="loan_amount" class="form-control" value="@if(isset($carLoan->id)){{$carLoan->loan_amount}}@else{{old('loan_amount')}}@endif">
                                                    </div>
                                                    <div class="col-md-4 mt-2">
                                                        <label for="tenure">Tenure:</label>
                                                        <input type="text" id="tenure_loan" name="tenure" class="form-control" value="@if(isset($carLoan->id)){{$carLoan->tenure}}@else{{old('tenure')}}@endif">
                                                    </div>
                                                    <div class="col-md-4 mt-2">
                                                    ...
                                                    <div class="col-md-4 mt-2">
                                                        ...
                                                        <input type="text" id="co_applicant" name="co_applicant" class="form-control" value="@if(isset($carLoan->id)){{$carLoan->co_applicant}}@else{{old('co_applicant')}}@endif">
                                                    </div>
                                                    <div class="col-md-4 mt-2">
                                                    ...
                                                    <div class="col-sm-4 mt-2">
                                                        ...
                                                        <select class="form-control" name="loan_type" id="loan_type">
                                                            <option value="" selected disabled>Choose...</option>
                                                            <option value="1" {{ isset($carLoan) && $carLoan->loan_type == '1' ? 'selected' : '' }}>Purchase</option>
                                                            <option value="2" {{ isset($carLoan) && $carLoan->loan_type == '2' ? 'selected' : '' }}>Refinance</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-sm-4 mt-2">
                                                        ...
                                                        <select class="form-control" name="car_type" id="car_type">
                                                            <option value="" selected disabled>Choose...</option>
                                                            <option value="1" {{ isset($carLoan) && $carLoan->car_type == '1' ? 'selected' : '' }}>Used</option>
                                                            <option value="2" {{ isset($carLoan) && $carLoan->car_type == '2' ? 'selected' : '' }}>New</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <hr style="border: #2A3F54 1px solid;">
