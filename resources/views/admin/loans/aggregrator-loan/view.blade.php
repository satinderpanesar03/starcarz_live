...
@section('title', 'View Aggregrator Loan')
@section('content')
                                ...
                                <div class="card-header" style="background-color: #d6d6d6; color: #000000;  z-index: 1;">
                                    <div class="row">
                                        <div class="col-12 col-sm-7">
                                            <h5 class="pt-2 pb-2">View Aggregrator Loan</h5>
                                        </div>
                                            ...
                                            <form method="post" action="{{route('admin.loan.aggregrator-loan.store')}}">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 mt-2">
                                                        ...
                                                        <input type="text" id="city" name="city" class="form-control" value="@if(isset($aggregratorLoan->id)){{$aggregratorLoan->city}}@else{{old('city')}}@endif" readonly>
                                                    </div>
                                                    <div class="col-md-4 mt-2">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        ...
                                                        <select class="form-control" name="type" id="type" disabled>
                                                            <option value="" {{ $aggregratorLoan->type === '' ? 'selected' : '' }} disabled>Choose...</option>
                                                            <option value="1" {{ $aggregratorLoan->type == '1' ? 'selected' : '' }}>Purchase</option>
                                                            <option value="2" {{ $aggregratorLoan->type == '2' ? 'selected' : '' }}>Refinance</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-4 mt-2">
                                                        ...
                                                        <input type="text" name="executive" class="form-control" value="@if(isset($aggregratorLoan->id)){{$aggregratorLoan->executive}}@else{{old('executive')}}@endif" readonly>
                                                    </div>
                                                    <div class="col-md-4 mt-2">
