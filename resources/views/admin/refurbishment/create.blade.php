                                            ...
                                            <form method="post" action="{{route('admin.refurbishment.store')}}" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="date" id="date" name="date" class="form-control" value="{{ isset($refurbishment) ? \Carbon\Carbon::parse($refurbishment->date)->format('Y-m-d') : old('date') }}">
                                                    </div>
                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-3 mt-3">
                                                        ...
                                                        <input type="text" name="total_amount" id="total_amount" class="form-control" placeholder="Enter Amount" value="@if(isset($refurbishment->id)){{$refurbishment->total_amount}}@else{{old('total_amount')}}@endif" required data-validation-required-message="Name field is required">
                                                    </div>
                                                    <div class="col-md-3 mt-3">
                                                ...
                                                <div id="sections">
                                                    ...
                                                    <div class="row section">
                                                        ...
                                                        <div class="col-md-3 mt-3">
                                                            ...
                                                            <select name="sections[{{ $index }}][mst_supplier_id]" class="form-control">
                                                                <option value="">Choose...</option>
                                                                @foreach($suppliers as $value => $label)
                                                        ...
                                                        <div class="col-md-3 mt-3">
                                                            ...
                                                            <input type="date" name="sections[{{ $index }}][voucher_date]" class="form-control" placeholder="Enter Amount" value="{{ isset($refurbishedDetail['voucher_date']) ? $refurbishedDetail['voucher_date'] : old('voucher_date') }}">
                                                        </div>
                                                        <div class="col-md-3 mt-3">
                                                            <label for="amount">Amount:</label>
                                                            <input type="text" name="sections[{{ $index }}][amount]" class="form-control" placeholder="Enter Amount" value="{{ isset($refurbishedDetail['amount']) ? $refurbishedDetail['amount'] : old('amount') }}">
                                                        </div>
                                                        <div class="col-md-3 mt-3">
                                                            <label for="description">Description:</label>
            ...
            if (mode) {
                $.ajax({
                    ...
                    success: function(data) {
                        console.log(data);
                        $('#vehicle_number').html('<option value="">Select Vehicle Number</option>');
        ...
        $('#model_id').on('change', function() {
            ...
            if(modelId){
                $.ajax({
                        ...
                        dataType: 'json',
                        success: function(data) {
                            var vehicleSelect = $('#vehicle_number');
                            vehicleSelect.empty();
                            vehicleSelect.append('<option value="">Select Vehicle Number</option>');
                            $.each(data.vehicles, function(key, value) {
                                vehicleSelect.append('<option value="'+ value.id +'">'+ value.number +'</option>');
                            });
                        },
                        error: function(xhr) {
