                                        ...
                                        <div class="card-body auth-img">
                                            <div class="row m-0">
                                                <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center auth-img-bg p-3">
                                                    @if(isset($company))
                                                    <img src="{{ asset('storage/' . $company->logo) }}" alt="{{ $company->name }} Logo" class="img-fluid" width="300" height="230">
                                                ...
                                                <div class="col-lg-6 col-12 px-4 py-3">
                                                    ...
                                                    <form action="{{route('admin.login')}}" method="post">
                                                        ...
                                                        <input type="text" class="form-control mb-2" placeholder="Username" name="email" value="{{ old('email') }}">
                                                        <p class="mb-2 error">@error('email') {{ $message }} @enderror</p>

                                                        <input type="password" class="form-control mb-2" placeholder="Password" name="password">
                                                        <p class="mb-2 error"> @error('password'){{ $message }}@enderror</p>
